...
var S3AlbumComponent = /** @class */ (function () {
    ...
    S3AlbumComponent.prototype.loadComponent = function () {
        var _this = this;
        var albumComponent = this.framework && this.framework.toLowerCase() === 'ionic' ? new ComponentMount(S3AlbumComponentIonic, { path: this.path }) : new ComponentMount(S3AlbumComponentCore, { path: this.path });
