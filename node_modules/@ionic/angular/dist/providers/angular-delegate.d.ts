...
export declare class AngularFrameworkDelegate implements FrameworkDelegate {
    ...
    private zone;
    private elRefMap;
    constructor(resolver: ComponentFactoryResolver, injector: Injector, location: ViewContainerRef, appRef: ApplicationRef, zone: NgZone);
    attachViewToDom(container: any, component: any, params?: any, cssClasses?: string[]): Promise<any>;
    removeViewFromDom(_container: any, component: any): Promise<void>;
}
export declare function attachView(resolver: ComponentFactoryResolver, injector: Injector, location: ViewContainerRef | undefined, appRef: ApplicationRef, elRefMap: WeakMap<HTMLElement, any>, container: any, component: any, params: any, cssClasses: string[]): any;
