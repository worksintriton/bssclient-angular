...
@Component({
  selector: 'app-feedbackhistroty',
  templateUrl: './feedbackhistroty.component.html',
  styleUrls: ['./feedbackhistroty.component.scss']
})
export class FeedbackhistrotyComponent implements OnInit {
