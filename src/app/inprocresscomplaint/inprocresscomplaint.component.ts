...
@Component({
  selector: 'app-inprocresscomplaint',
  templateUrl: './inprocresscomplaint.component.html',
  styleUrls: ['./inprocresscomplaint.component.scss']
})
export class InprocresscomplaintComponent implements OnInit {
