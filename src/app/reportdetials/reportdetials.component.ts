...
@Component({
  selector: 'app-reportdetials',
  templateUrl: './reportdetials.component.html',
  styleUrls: ['./reportdetials.component.scss']
})
export class ReportdetialsComponent implements OnInit {
